...
<head>
  ...
  <link rel="stylesheet" href="{{HttpSrvBasePath "~/htap/css/main.css"}}" type="text/css">
  <link rel="shortcut icon" type="image/x-icon" href="{{HttpSrvBasePath "~/htap/img/ap.ico"}}">
  ...
  <script src="{{HttpSrvBasePath "~/htap/js/main.js"}}"></script>
