<head>
  ...
  <link rel="stylesheet" href="{{HttpSrvBasePath "hpress/~/bs/3.3/css/bootstrap.css"}}?v={{.sys_version_sign}}" type="text/css">
  <link rel="stylesheet" href="{{HttpSrvBasePath "hpress/~/hpress/css/main.css"}}?v={{.sys_version_sign}}" type="text/css">
