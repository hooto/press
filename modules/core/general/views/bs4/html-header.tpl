<head>
  ...
  <link rel="stylesheet" href="{{HttpSrvBasePath "hp/~/bs/4.0/css/bootstrap.css"}}?v={{.sys_version_sign}}" type="text/css">
  <link rel="stylesheet" href="{{HttpSrvBasePath "hp/~/hp/css/base.css"}}?v={{.sys_version_sign}}" type="text/css">
