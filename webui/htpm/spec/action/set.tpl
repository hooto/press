<style>
.htpm-spec-action-datax-attr-item td {
  padding: 0 2px 4px;
}
</style>

<div id="htpm-spec-actionset-alert"></div>

<div id="htpm-spec-actionset">
  ...
  <div class="form-group">
    ...
    <div>
      ...
      <tbody id="htpm-spec-action-dataxs">
        {[~it.datax :v]}
        <tr id="datax-seq-{[=v._seqid]}" class="htpm-spec-action-datax-item">
...
<script id="htpm-spec-action-datax-item-tpl" type="text/html">
  <tr id="datax-seq-{[=it._seqid]}" class="htpm-spec-action-datax-item">
