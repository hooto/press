...
hpSpecEditor.Open = function(modname) {
    var topnav = $("#hp-uh-topnav");
    ...
    $("#hp-uh-topnav").append("<a class=\"l4i-nav-item active\" modname=\"" + modname + "\" href=\"#spec-editor/" + modname + "\">Spec Editor (" + modname + ")</a>");
...
hpSpecEditor.Index = function(modname) {
    if (!modname) {
        return;
    }
    ...
    hpMgr.TplCmd("spec/editor/desk", {
        callback: function(err, data) {
            ...
            l4iTemplate.RenderFromID("lcbind-proj-filenav", "hp-speceditor-fsnav-tpl");
...
l9rProjFs.OpenHistoryTabs = function() {
    ...
    lcData.Query("files", "projdir", l4iSession.Get("hp-speceditor-modname"), function(ret) {
        ...
        if (ret.value.id && ret.value.projdir == l4iSession.Get("hp-speceditor-modname")) {
...
l9rPodFs.Rename = function(options) {
    ...
    var url = "mod-set-fs/rename?modname=" + l4iSession.Get("hp-speceditor-modname");
    hpMgr.ApiCmd(url, {
        method: "POST",
        timeout: 10000,
        data: JSON.stringify(req),
...
l9rPodFs.List = function(options) {
    ...
    var url = "mod-set-fs/list?modname=" + l4iSession.Get("hp-speceditor-modname");
    url += "&path=" + options.path;
...
l9rLayout.Initialize = function() {
    ...
    for (var i in l9rLayout.cols) {
        ...
        var wl = l4iStorage.Get(l4iSession.Get("hp-speceditor-modname") + "_laysize_" + l9rLayout.cols[i].id);
...
l9rLayout.BindRefresh = function() {
    $(".lclay-col-resize").bind("mousedown", function(e) {
        ...
        $("#lcbind-layout").bind("mousemove", function(e) {
            ...
            l4iStorage.Set(l4iSession.Get("hp-speceditor-modname") + "_laysize_" + leftLayId, leftWidthNew);
            l4iSession.Set("laysize_" + leftLayId, leftWidthNew);
            l4iStorage.Set(l4iSession.Get("hp-speceditor-modname") + "_laysize_" + rightLayId, rightWidthNew);
