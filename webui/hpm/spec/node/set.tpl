...
<div id="hpm-spec-nodeset-alert"></div>

<div id="hpm-spec-nodeset">
    ...
    <div>
      ...
      <tbody id="hpm-spec-node-fields">
        ...
        <tr id="field-seq-{[=v._seqid]}" class="hpm-spec-node-field-item">
          ...
          <td>
            <table><tbody class="hpm-spec-node-field-attrs">
              {[~v.attrs :atv]}
          ...
          <td>
            <button class="btn btn-default btn-sm" onclick="hpSpec.NodeSetFieldAttrAppend('{[=v._seqid]}')">+ Attribute</button>
          </td>
        </tr>
        {[~]}
      </tbody>
...
<script id="hpm-spec-node-field-item-tpl" type="text/html">
  <tr id="field-seq-{[=it._seqid]}" class="hpm-spec-node-field-item">
    ...
    <td>
      <table><tbody class="hpm-spec-node-field-attrs"></tbody></table>
    </td>
    <td>
      <button class="btn btn-default btn-sm" onclick="hpSpec.NodeSetFieldAttrAppend('{[=it._seqid]}')">+ Attribute</button>
    </td>
  </tr>
</script>
