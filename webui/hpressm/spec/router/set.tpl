<style type="text/css">
#hpressm-spec-route-params td {
  padding: 0 10px 10px 0;
}
</style>

<div id="hpressm-spec-routeset-alert"></div>
<div id="hpressm-spec-routeset"></div>

<script id="hpressm-spec-routeset-tpl" type="text/html">
  ...
  <div class="form-group">
    ...
    <div class="input-group">
      <input id="hpressm-spec-routeset-template" type="text" class="form-control" name="template" placeholder="Template Path" value="{[=it.template]}">
      <span class="input-group-btn">
        <button class="btn btn-default" type="button" onclick="hpressSpec.RouteSetTemplateSelect('{[=it._modname]}')">Select a Template</button>
      </span>
    </div>
  </div>
...
<tr class="hpressm-spec-route-param-item">
  <td>
