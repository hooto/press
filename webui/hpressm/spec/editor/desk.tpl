...
<script id="hpress-speceditor-fsnav-tpl" type="text/html">
<div class="lcx-fsnav">
            ...
            <ul class="lfnm-item-submenu">
                <li>
                    <a href="#proj/fs/file-new" onclick="l9rProjFs.FileNew('file', null, '')">
                        <img src="~/hpressm/img/page_white_add.png" class="h5c_icon" />
                        New File
                    </a>
                </li>
                <li>
                    <a href="#proj/fs/file-upl" onclick="l9rProjFs.FileUpload(null)">
                        <img src="~/hpressm/img/page_white_get.png" class="h5c_icon" />
                        Upload
                    </a>
                </li>
            </ul>
...
<div id="ptp{[=v.fsid]}" class="lcx-fsitem" 
  lc-fspath="{[=v.path]}" lc-fstype="{[=v.fstype]}" lc-fsico="{[=v.ico]}">
    <img src="{[=hpressMgr.frtbase]}~/hpressm/img/{[=v.ico]}.png" align="absmiddle">
...
<div id="lcbind-fsnav-rcm" style="display:none">  
  <div class="lcbind-fsrcm-item fsrcm-isdir" lc-fsnav="new-file">
    <div class="rcico">
        <img src="~/hpressm/img/page_white_add.png" align="absmiddle" />
    </div>
    <a href="#" class="rcctn">New File</a>
  </div>
  <div class="lcbind-fsrcm-item fsrcm-isdir" lc-fsnav="upload">
    <div class="rcico">
        <img src="~/hpressm/img/page_white_get.png" align="absmiddle">
    </div>
  ...
  <div class="lcbind-fsrcm-item" lc-fsnav="rename">
    <div class="rcico">
        <img src="~/hpressm/img/page_white_copy.png" align="absmiddle">
    </div>
    <a href="#" class="rcctn">Rename</a>
  </div>
  <div class="lcbind-fsrcm-item" lc-fsnav="file-del">
    <div class="rcico">
        <img src="~/hpressm/img/delete.png" align="absmiddle">
    </div>
...
<form id="{[=it.formid]}" action="#" onsubmit="l9rProjFs.FileNewSave('{[=it.formid]}');return false;">
  <div class="input-prepend" style="margin-left:2px">
    <span class="add-on">
        <img src="{[=hpressMgr.frtbase]}~/hpressm/img/folder_add.png" class="h5c_icon">
        {[=it.path]}
    </span>
...
<form id="{[=it.formid]}" action="#" onsubmit="l9rProjFs.FileRenameSave('{[=it.formid]}');return false;">
  <div class="input-prepend" style="margin-left:2px">
    <span class="add-on">
        <img src="{[=hpressMgr.frtbase]}~/hpressm/img/folder_edit.png" class="h5c_icon">
    </span>
...
<div id="{[=it.reqid]}">
  ...
  <div class="input-prepend">
    <span class="add-on"><img src="{[=hpressMgr.frtbase]}~/hpressm/img/page_white_get.png" align="absmiddle"></span>
