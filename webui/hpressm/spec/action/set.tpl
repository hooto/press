<style>
.hpressm-spec-action-datax-attr-item td {
  padding: 0 2px 4px;
}
</style>

<div id="hpressm-spec-actionset-alert"></div>

<div id="hpressm-spec-actionset">
  ...
  <div class="form-group">
    ...
    <div>
      ...
      <tbody id="hpressm-spec-action-dataxs">
        {[~it.datax :v]}
        <tr id="datax-seq-{[=v._seqid]}" class="hpressm-spec-action-datax-item">
...
<script id="hpressm-spec-action-datax-item-tpl" type="text/html">
  <tr id="datax-seq-{[=it._seqid]}" class="hpressm-spec-action-datax-item">
